...
public class MyDriver {
     ...
     * Webdriver object should be thread safe.
     * A single object can be used with multiple threads at the same time without causing problems.
     */
    ...
    public static WebDriver get() {
        ...
        if (driverPool.get() == null) {
            ...
            String browser = browserParamFromEnv == null ? utils.ConfigurationReader.getProperty("browser") : browserParamFromEnv;
            switch (browser) {
                case "chrome":
